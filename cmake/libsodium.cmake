...
elseif(LINUX)
    set(LIBSODIUM_LIBRARIES "${LIBRARIES_ROOT_DIR}/libsodium/Linux/libsodium.a" CACHE INTERNAL "LIBSODIUM_LIBRARIES")

    set(LIBSODIUM_INCLUDE_DIRS "${LIBRARIES_ROOT_DIR}/libsodium/linux/include" CACHE INTERNAL "LIBSODIUM_INCLUDE_DIRS")
else()
    set(LIBSODIUM_LIBRARIES "${LIBRARIES_ROOT_DIR}/libsodium/darwin/libsodium.a" CACHE INTERNAL "LIBSODIUM_LIBRARIES")
