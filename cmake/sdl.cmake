...
elseif (IOS)
    ...
    set(SDL2_LIBRARIES "${LIBRARIES_ROOT_DIR}/sdl/ios/libSDL2.a;${LIBRARIES_ROOT_DIR}/sdl/ios/libSDL2main.a;${LIBRARIES_ROOT_DIR}/sdl/ios_simulator/libSDL2.a;${LIBRARIES_ROOT_DIR}/sdl/ios_simulator/libSDL2main.a;-lm -liconv -Wl,-framework,CoreAudio -Wl,-framework,AudioToolbox -Wl,-weak_framework,CoreHaptics -Wl,-weak_framework,GameController -lobjc -Wl,-framework,CoreVideo,-framework,IOKit -Wl,-weak_framework,QuartzCore -Wl,-weak_framework,Metal -Wl,-weak_framework,AVFoundation -Wl,-weak_framework,CoreMotion -Wl,-weak_framework,CoreGraphics -Wl,-weak_framework,OpenGLES -Wl,-weak_framework,UIKit -Wl,-weak_framework,Foundation" CACHE INTERNAL "SDL2_LIBRARIES")
