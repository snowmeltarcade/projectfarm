#ifndef PROJECTFARM_SERVER_CLIENT_PLAYER_JOINED_WORLD_H
#define PROJECTFARM_SERVER_CLIENT_PLAYER_JOINED_WORLD_H
...
{
    class ServerClientPlayerJoinedWorld final : public Packet
    {
    public:
        ServerClientPlayerJoinedWorld() = default;
        ~ServerClientPlayerJoinedWorld() override = default;

        [[nodiscard]] PacketTypes GetPacketType() const override
        {
            return PacketTypes::ServerClientPlayerJoinedWorld;
        }
